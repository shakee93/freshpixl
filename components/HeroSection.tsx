...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center bg-black pt-20 px-6">
      ...
      <div className="relative z-10 flex flex-col items-center w-full max-w-[1200px] px-0">
        {/* Pill badge */}
        <div className="relative mb-8 rounded-full">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, rgba(255, 255, 255, 0.1) 0%, rgba(153, 153, 153, 0.1) 14.66%)",
            }}
          >
        ...
        <div className="relative w-full max-w-[1200px] pb-6 lg:pt-20 pt-16 mt-16 lg:mt-32">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
            {stats.map((stat) => (
              <div
                key={stat.value}
                className="flex items-stretch gap-4 pointer-events-none"
              >
                <StatsIcon className="h-full w-auto" />
                <div>
                  <p
                    className="lg:text-[28px] text-[24px] font-bold text-white"
